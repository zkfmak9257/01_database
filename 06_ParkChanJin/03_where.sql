...
-- NOT BETWEEN A AND B : A이상 B이하 범위가 아닌 것 지정
...
/*
    ...
    1) ESCAPE OPTION
    ex) WHERE temp_email LIKE '___#_%' ESCAPE '#';
    -> ESCAPE OPTION을 이용하여 와일드카드를 문자열로 탈출
*/
SELECT
    *
FROM
...
/*
    2) \(백슬래시) ESCAPE 문자
    ex) WHERE temp_email LIKE '___\_%';
*/
