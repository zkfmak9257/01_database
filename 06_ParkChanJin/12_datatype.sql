...
-- SINGNED INTEGER, UNSIGNED INTEGER 차이
-- SINGNED : 부호(+, -) 를 포함한 범위의 INTEGER(-21.47억 ~ +21.47억)
...
-- 날짜로 바꿔서 대소비교 가능 0, 1 로 출력됨
SELECT
    CAST('2025-11-06 10:20:40' AS DATETIME) < CAST('2025-11-05 10:20:40' AS DATETIME);
...
--        문자열 크기에 맞춰서 숫자가 잘림
SELECT
    CAST(menu_price AS CHAR(1)) AS '문자열 가격'
FROM
    tbl_menu;


-- CONCAT : 다 문자열이여야 사용 가능
SELECT
