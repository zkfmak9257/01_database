...
-- AUTO_INCREMENT : NULL 허용 PK 컬럼에 NULL 삽입 시 자동으로 증가된 숫자를 삽입
...
/* REPLACE : 중복된 데이터를 덮어쓸 수 있음
    ...
    - REPLACE 는 에러를 무시하고 덮어씌움
*/
SELECT * FROM tbl_menu;

INSERT INTO
    tbl_menu VALUES (17, '참기름소주', 5000, 10, 'Y'); -- 에러 발생

REPLACE INTO
    tbl_menu VALUES (17, '참기름소주', 5000, 10, 'Y');
