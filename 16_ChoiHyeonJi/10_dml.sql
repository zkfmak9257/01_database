...
-- AUTO_INCREMENT : NULL 허용 PK 컬럼에 NULL 삽입 시 자동으로 증가된 숫자 삽입 // 이전거보다 하나 더 큼
...
UPDATE tbl_menu
   SET category_code = ((SELECT menu_code
                      FROM tbl_menu
...
INSERT INTO tbl_menu VALUES (17, '참기름소주',
                             5000, 10, 'Y'); -- 에러 발생

REPLACE INTO tbl_menu VALUES (17, '참기름소주',
                              5000, 10, 'Y');


SELECT * FROM tbl_menu;

 -- WHERE 절 없이도 PK(menu_code) 값이 일치하는 행을 찾아서 UPDATE 진행
REPLACE tbl_menu
    SET menu_code = 2
      , menu_name = '우럭쥬스'
      , menu_price = 2000
