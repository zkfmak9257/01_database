...
SELECT CAST(SUM(tbl_menu.menu_price) AS CHAR)
FROM tbl_menu;

-- SIGNED INTEGER, UNSIGNED 차이
-- SIGNED : 부호(+-)를 포함하지 않는 범위의 INTEGER (-21.47억 ~ +21.47억)
...
SELECT CAST('2023-11-06 10:20:40' AS DATETIME)
           > CAST('2023-11-05 10:20:40' AS DATETIME);
...
SELECT CONCAT(CAST(menu_price AS CHAR(4)), '원'),
       CONCAT(menu_price, '원')
