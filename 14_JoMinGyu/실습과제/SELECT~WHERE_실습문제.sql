...
from
    tbl_menu
where
    menu_price >= 5000 and orderable_status = 'Y'
...
from
    tbl_menu
where
    category_code in (6, 10) and orderable_status = 'Y'
...
from
    tbl_menu
where
    menu_price >= 7000 and category_code in (4, 6, 10) and orderable_status = 'Y'
order by
    menu_price
...
from
    tbl_menu
where
    menu_name like '%아%' or menu_price <= 5000
order by
    menu_name
...
from
    tbl_menu
where
    category_code between 8 and 12 and menu_name like '%빵%'
...
from
    tbl_menu
where
    orderable_status = 'N' or (menu_price < 10000 and (menu_name like '%빵' or menu_name like '%떡' or menu_name like '%찜'))
