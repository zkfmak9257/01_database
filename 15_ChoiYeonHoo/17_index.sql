...
CREATE INDEX idx_name
    ON phone(phone_name); -- phone_name 에 대한 인덱스 생성
...
WHERE STATISTICS.TABLE_SCHEMA = 'menudb'
...
-- INDEX 생성 (phone_name 컬럼)
CREATE INDEX idx_name ON phone(phone_name); -- phone_name 에 대한 인덱스 생성
...
select * from students where name = '학생49723'; -- 인덱스 사용 안한 것
select * from students where id = 49723; -- 인덱스 사용 한 것
